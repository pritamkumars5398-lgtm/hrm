...
const variants: Record<Variant, string> = {
  ...
  primary: 'bg-[#059669] hover:bg-[#047857] text-white border border-transparent transition-all duration-200',
  ...
  premium: 'bg-[#059669] hover:bg-[#047857] text-white border border-transparent transition-all duration-200 hover:shadow-md',
}
