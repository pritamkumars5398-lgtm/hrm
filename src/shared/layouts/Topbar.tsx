                  ...
                  return (
                    <li key={m.organizationId}>
                      <button
                        ...
                        className={`flex w-full items-center justify-between px-4 py-2.5 text-left text-[13px] transition-colors hover:bg-wash ${isActive ? 'bg-pine-tint/30 font-medium text-pine-deep' : 'text-ink'
                          }`}
                      >
